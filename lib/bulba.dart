...
class Bulba extends StatefulWidget {
  const Bulba({Key? key}) : super(key: key);

  @override
  _BulbaState createState() => _BulbaState();
}

class _BulbaState extends State<Bulba> {
  ControleAnim controller = ControleAnim();
  @override
  void initState() {
    controller.img = '${controller.url}/bulba.png';
    super.initState();
  }
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                          onPressed: () {
                            ...
                            controller.evolui(
                                '${controller.url}/bulba.png',
                                '${controller.url}/ivisauro.png',
                                '${controller.url}/venosauro.png',
                                'Bulbassauro');
                          },
                          child: Image.asset(
                            controller.img,
