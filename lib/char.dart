...
class Charmander extends StatefulWidget {
  const Charmander({Key? key}) : super(key: key);
...
class _CharmanderState extends State<Charmander> {
  ...
  @override
  void initState() {
    controller.img = '${controller.url}/charmander.png';
    super.initState();
  }
          ...
          builder: (context) => Container(
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('assets/img/volcan.png'),
                        fit: BoxFit.fill)),
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                          onPressed: () {
                            ...
                            controller.evolui(
                                '${controller.url}/charmander.png',
                                '${controller.url}/charmeleon.png',
                                '${controller.url}/charizard.png',
                                'Charmander');
                          },
                          child: Image.asset(
                            controller.img,
