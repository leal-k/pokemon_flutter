...
class Squirtle extends StatefulWidget {
  const Squirtle({Key? key}) : super(key: key);

  @override
  _SquirtleState createState() => _SquirtleState();
}

class _SquirtleState extends State<Squirtle> {
  ControleAnim controller = ControleAnim();
  @override
  void initState() {
    controller.img = '${controller.url}/squirtle.png';
    super.initState();
  }
          ...
          builder: (context) => Container(
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('assets/img/sea.png'),
                        fit: BoxFit.fill)),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                          onPressed: () {
                            controller.dimTamanho();
                            controller.evolui(
                                '${controller.url}/squirtle.png',
                                '${controller.url}/wartortle.png',
                                '${controller.url}/blastoise.png',
                                'Squirtle');
                          },
                          child: Image.asset(
                            controller.img,
                            scale: controller.escala,
                          )),
                    ),
